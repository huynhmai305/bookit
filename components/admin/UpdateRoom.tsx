...
const UpdateRoom: React.FC = () => {
  ...
  } = useSelector((state: RootState) => state.roomDetails);
  ...
  const [oldImages, setOldImages] = useState<Array<any>>([]);
  ...
  }, [dispatch, error, id, isUpdated, room, roomDetailsError, router]);
